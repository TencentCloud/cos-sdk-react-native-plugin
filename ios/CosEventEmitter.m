...
- (NSArray<NSString *> *)supportedEvents{
    return @[COS_EMITTER_UPDATE_SESSION_CREDENTIAL, COS_EMITTER_DNS_FETCH, COS_EMITTER_RESULT_SUCCESS_CALLBACK, COS_EMITTER_RESULT_FAIL_CALLBACK, COS_EMITTER_PROGRESS_CALLBACK, COS_EMITTER_STATE_CALLBACK, COS_EMITTER_INIT_MULTIPLE_UPLOAD_CALLBACK];
}
